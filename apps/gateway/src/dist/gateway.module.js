        ...
        common_1.Module({
            ...
            providers: [
                gateway_service_1.GatewayService,
                {
                    ...
                    useFactory: function (nacosService) { return __awaiter(void 0, void 0, void 0, function () {
                        var serviceInstance;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, nacosService.discoverService('user')];
                                case 1:
                                    serviceInstance = _a.sent();
                                    console.log("-----------------------------------------------------------------------------------------" + serviceInstance[0].ip);
                                    return [2 /*return*/, microservices_1.ClientProxyFactory.create({
                    ...
                    inject: [nacos_1.NacosService]
                },
                userService_service_1.UserAdapterService,
            ]
        })
    ], GatewayModule);
